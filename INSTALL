...
----
Installing SeansLifeArchive/Images/Clash of Clans
----

SeansLifeArchive/Images/ClashofClans currently doesn't require installation, it is just a collection of images and data. It is part of the Seanpm2001 Life Archive project, and for proper "installation" the repository should be placed under /SeansLifeArchive/<yourInstalledVersion>/Resources/Images/
...
----
Install instructions file version: 2 (Sunday, 2022, April 24th at 9:01 pm PST)
----
